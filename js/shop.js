...
(function() {
  ...
  const products = [
    { id: 'iphone15pm', name: 'iPhone 15 Pro Max', brand: 'Apple', image: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&h=400&fit=crop&crop=center', price: 57499, oldPrice: 62499, storage: '256GB', ram: '8GB', color: 'Titanium', condition: 'new', battery: 100, warranty: '12 Months', rating: 5, reviews: 128, stock: true, category: 'phones', badge: 'New', popular: 95 },
    { id: 's24ultra', name: 'Galaxy S24 Ultra', brand: 'Samsung', image: 'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=400&h=400&fit=crop&crop=center', price: 52499, oldPrice: 62499, storage: '512GB', ram: '12GB', color: 'Titanium Gray', condition: 'new', battery: 100, warranty: '12 Months', rating: 5, reviews: 94, stock: true, category: 'phones', badge: 'Sale', popular: 90 },
    ...
    { id: 'oneplus12', name: 'OnePlus 12', brand: 'OnePlus', image: 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=400&h=400&fit=crop&crop=center', price: 33499, oldPrice: 37999, storage: '256GB', ram: '16GB', color: 'Flowy Emerald', condition: 'new', battery: 100, warranty: '12 Months', rating: 5, reviews: 52, stock: true, category: 'phones', badge: 'Best Seller', popular: 85 },
    ...
    { id: 'zfold5', name: 'Galaxy Z Fold 5', brand: 'Samsung', image: 'https://images.unsplash.com/photo-1692307441614-c88d37a5ecaa?w=400&h=400&fit=crop&crop=center', price: 86499, oldPrice: 0, storage: '256GB', ram: '12GB', color: 'Icy Blue', condition: 'new', battery: 100, warranty: '12 Months', rating: 5, reviews: 43, stock: true, category: 'phones', badge: 'Premium', popular: 78 },
    { id: 'mi14pro', name: 'Xiaomi 14 Pro', brand: 'Xiaomi', image: 'https://images.unsplash.com/photo-1774437342043-12ffa8880899?w=400&h=400&fit=crop&crop=center', price: 35999, oldPrice: 0, storage: '256GB', ram: '12GB', color: 'Black', condition: 'new', battery: 100, warranty: '12 Months', rating: 4, reviews: 67, stock: true, category: 'phones', badge: '', popular: 80 },
    ...
    { id: 'ip14pm', name: 'iPhone 14 Pro Max', brand: 'Apple', image: 'https://images.unsplash.com/photo-1727093493864-0bcbd16c7e6d?w=400&h=400&fit=crop&crop=center', price: 42999, oldPrice: 52499, storage: '256GB', ram: '6GB', color: 'Deep Purple', condition: 'new', battery: 100, warranty: '12 Months', rating: 5, reviews: 186, stock: true, category: 'phones', badge: '-18%', popular: 70 },
    { id: 'mi13tp', name: 'Xiaomi 13T Pro', brand: 'Xiaomi', image: 'https://images.unsplash.com/photo-1754331732629-d281d5797956?w=400&h=400&fit=crop&crop=center', price: 23999, oldPrice: 30999, storage: '256GB', ram: '12GB', color: 'Alpine Blue', condition: 'new', battery: 100, warranty: '12 Months', rating: 4, reviews: 92, stock: true, category: 'phones', badge: '-25%', popular: 65 },
    { id: 'op11', name: 'OnePlus 11', brand: 'OnePlus', image: 'https://images.unsplash.com/photo-1527747471697-174c755627dd?w=400&h=400&fit=crop&crop=center', price: 23999, oldPrice: 30999, storage: '256GB', ram: '16GB', color: 'Eternal Green', condition: 'new', battery: 100, warranty: '12 Months', rating: 4, reviews: 78, stock: false, category: 'phones', badge: '-22%', popular: 60 },
    { id: 'honor90', name: 'Honor 90', brand: 'Honor', image: 'https://images.unsplash.com/photo-1551636898-47668aa61de2?w=400&h=400&fit=crop&crop=center', price: 21499, oldPrice: 0, storage: '256GB', ram: '12GB', color: 'Emerald Green', condition: 'new', battery: 100, warranty: '12 Months', rating: 4, reviews: 34, stock: true, category: 'phones', badge: 'New', popular: 55 },
    { id: 'oppofindn3', name: 'OPPO Find N3 Flip', brand: 'Oppo', image: 'https://images.unsplash.com/photo-1649859394614-dc4f7290b7f2?w=400&h=400&fit=crop&crop=center', price: 47999, oldPrice: 0, storage: '256GB', ram: '12GB', color: 'Gold', condition: 'new', battery: 100, warranty: '12 Months', rating: 4, reviews: 22, stock: true, category: 'phones', badge: 'New', popular: 58 },
  ];
